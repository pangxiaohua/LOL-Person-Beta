...
@interface GuanFangChaXunController ()<UIWebViewDelegate>
@property(nonatomic,strong)UIWebView *webView;
@property(nonatomic,strong)iKYLoadingHubView *loading;
@end

@implementation GuanFangChaXunController
...
-(UIWebView *)webView{
    if (!_webView) {
        ...
        NSString *path = @"http://lol.qq.com/web201310/personal.shtml?appName=lol";
