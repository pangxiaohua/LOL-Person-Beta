...
@interface JingPinShouYouController ()<UIWebViewDelegate>
@property(nonatomic,strong)UIWebView *webView;
@property(nonatomic,strong)iKYLoadingHubView *loading;

@end

@implementation JingPinShouYouController
...
-(UIWebView *)webView{
    if (!_webView) {
        ...
        NSString *path = @"http://m.zhangyoubao.com/down/index?&appName=lol";
